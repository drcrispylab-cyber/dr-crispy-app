...
function usarDireccionGuardada(direccionId) {
  ...
  setCliente((prev) => ({
    ...prev,
    direccion: prev.direccion === LAB_DIRECCION ? "" : prev.direccion,
    referencia: prev.referencia === LAB_REFERENCIA ? "" : prev.referencia,
  }));
  ...
  <>
    <div style={styles.globalCartBody}>
      {mostrarPromptPerfil && !clienteSesion?.id && (
        <div style={styles.checkoutGuestBox}>
          <div style={styles.checkoutGuestBadge}>👤 PERFIL RECOMENDADO</div>
          <h3 style={styles.checkoutGuestTitle}>
            Ingresa o crea tu perfil para pedir más rápido
          </h3>
          <p style={styles.checkoutGuestText}>
            Así autocompletas tus datos en próximos pedidos y mejoras la experiencia.
          </p>
            ...
            <div style={styles.globalCartActions}>
              ...
              <button
                ...
                style={{
                  ...styles.confirmBtn,
                  marginTop: 0,
                  ...((cargandoPedido || !laboratorioAbierto)
                    ? styles.disabledBtn
                    : {}),
                }}
                onClick={async () => {
